...
class Dependencies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, description, parts, user', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, description, parts, user', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'performer'=>array(self::BELONGS_TO, 'User', 'user', 'together'=>true),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('user',$this->users,true);
